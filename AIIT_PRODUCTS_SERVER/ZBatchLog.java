...
//フィールド
  ...
  final String[] dirs	  = {"/home/pi/Batch/Log",
	 "/home/vagrant/development/WEB/application/var/www/app"};		   //Pi用とサーバ用
...
//コンストラクタ
  ...
  public ZBatchLog(String filename)	 {
	  ...
	  try {
		...
		properties.put("LOGDIR", "/home/vagrant/development/WEB/application/var/www/app/Log");
